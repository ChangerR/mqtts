...
#define MQTT_MEMORY_TAGS(DEFINE_MEMORY_TAG)   \
  ...
  DEFINE_MEMORY_TAG(MEM_TAG_SESSION, "SESSION") \
  DEFINE_MEMORY_TAG(MEM_TAG_SESSION_QUEUE, "SESSION_QUEUE") \
  DEFINE_MEMORY_TAG(MEM_TAG_SESSION_WORKER, "SESSION_WORKER") \
  DEFINE_MEMORY_TAG(MEM_TAG_MESSAGE_CACHE, "MESSAGE_CACHE")
